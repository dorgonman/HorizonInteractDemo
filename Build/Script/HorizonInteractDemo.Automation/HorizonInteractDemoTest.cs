...
namespace UnrealGame
{
	...
	public class HorizonInteractDemoTestConfig : UnrealTestConfiguration
	{
		/// <summary>
		/// Map to use
		/// </summary>
	...
	public class HorizonInteractDemoTest : UnrealTestNode<HorizonInteractDemoTestConfig>
	{
		public HorizonInteractDemoTest(UnrealTestContext InContext) : base(InContext)
		{
		}

		public override HorizonInteractDemoTestConfig GetConfiguration()
		{
			// just need a single client
			HorizonInteractDemoTestConfig Config = base.GetConfiguration();
