...
properties([
    parameters([
        ...
        string(name: 'SENTRY_PROJECT', defaultValue: 'horizoninteractdemo', description: 'Sentry project slug for this project'),
...
def cfg = [
    ...
    hordeToken: '',
    hordeGitStreamRepo: 'https://dev.azure.com/kanohorizonia/UEHorizonPlugin/_git/HorizonInteractDemo',
