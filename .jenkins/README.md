# Jenkins Automation for HorizonInteractDemo

This directory contains the Jenkins Pipeline configuration for the HorizonInteractDemo project. It uses a shared pipeline library to provide standardized Unreal Engine build and test workflows.
...
- `HorizonPlugin/HorizonInteractDemo/Build/Development` — `*StandaloneTestReport.tar` and `Intermediate/BuildArchive/doc/` public docs.
- `HorizonPlugin/HorizonInteractDemo/Build/UGSBuild` — `Intermediate/BuildUGS/NuGet/*.nupkg`.
