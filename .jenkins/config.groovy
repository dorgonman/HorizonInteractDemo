// HorizonInteractDemo — Jenkins Shared Library consumer configuration
...
def projectConfig() {
    return [
        ...
        deployWorkspace:        '',  // Auto-resolved if empty: "${sharedWorkspaceRoot}/HorizonPlugin/HorizonInteractDemo/Deploy"
        ...
        sentryProject: 'horizoninteractdemo',
        ...
        hordeGitStreamRepo: 'https://dev.azure.com/kanohorizonia/UEHorizonPlugin/_git/HorizonInteractDemo',  // Repo URL for Horde stream ID (without trailing .git)

        // === Plugin Validation ===
        // Plugin validation is opt-in in the shared library. This PluginDemo project enables it explicitly.
        bValidatePlugins:   true,
        pluginName:         'HorizonInteract',
        pluginValidationPaths: [
            'Plugins/HorizonInteract/HorizonInteract.uplugin',
        ],
        ...
        uprojectPath:       'HorizonInteractDemo.uproject',
    ]
}
